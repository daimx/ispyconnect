...
namespace iSpyApplication.Controls
{
    ...
    public sealed class CameraWindow : PictureBox, ISpyControl
    {
        ...
        public VolumeLevel VolumeControl = null;
        //{
        //    get
        //    {
        ...
        {
            get { return Camobject.settings.micpair>-1; }
        }

        public bool CanRecord
        {
            get { return IsEnabled && Helper.HasFeature(Enums.Features.Recording); }
        }

        public bool CanGrab
        {
            get { return IsEnabled && Helper.HasFeature(Enums.Features.Save_Frames); }
        }

        public bool HasFiles { get { return true; } }
        ...
        public void Listen()
        {
            if (VolumeControl != null && VolumeControl.IsEnabled)
            {
                ...
                if (VolumeControl.Listening)
                    LogToPlugin("Listening Started");
                else
                {
                    LogToPlugin("Listening Finished");
                }
            }
        }
        ...
        {
            if (Camera != null && Camera.VideoSource != null && IsEnabled && !IsClone && !IsReconnect && !VideoSourceErrorState)
            {
        ...
        public void StartSaving()
        {
            ...
            lock (_lockobject)
            {
                ...
                {
                    if (ErrorHandler != null)
                        ErrorHandler("Recording has been disabled in settings - feature set");
                    return;
                }
                ...
                {
                    if (ErrorHandler != null)
                        ErrorHandler("Skipped recording - maximum recording thread limit hit. See settings to modify the limit.");
                    return;
                }
            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        var vc = VolumeControl;
                        bool bAudio = vc != null && vc.AudioSource != null && vc.Micobject.settings.active;
        ...
        public void ExecutePluginCommand(string command)
        {
            if (Camera.Plugin != null)
            {
                ...
                if (a != null)
                {
                    ...
                    {
                        if (ErrorHandler != null)
                            ErrorHandler("Plugin response: " + a);
                    }
                }
